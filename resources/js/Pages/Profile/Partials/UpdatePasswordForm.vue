...
<template>
    <section>
        <header>
            <h2 class="text-base font-semibold text-surface-100">Update Password</h2>
            <p class="mt-1 text-sm text-surface-400">Use a strong, unique password to keep your account secure.</p>
        </header>
