    ...
    public function run(): void
    {
        ...
        EmailTemplate::updateOrCreate(
            ...
            [
                ...
                'body_html' => $this->newAnnouncementTemplate(),
            ]
        );
    }
...
HTML;
    ...
    private function newAnnouncementTemplate(): string
    {
        return <<<'HTML'
<!DOCTYPE html>
<html lang="en">
...
<p style="margin:0 0 24px;font-size:14px;color:#94a3b8;line-height:1.5;">
{{sender_name}} posted a new announcement for you.
</p>

<!-- Announcement body -->
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 24px;">
<tr>
<td style="background-color:#0f172a;border:1px solid #334155;border-radius:10px;padding:18px 20px;">
<table role="presentation" width="100%" cellpadding="0" cellspacing="0">
<tr>
...
<td style="padding-left:12px;vertical-align:top;">
<p style="margin:0 0 8px;font-size:13px;font-weight:600;color:#84cc16;">{{sender_name}}</p>
<div style="margin:0;font-size:14px;color:#e2e8f0;line-height:1.6;">{{body_html}}</div>
</td>
</tr>
</table>
</td>
...
<tr>
<td align="center" style="background-color:#84cc16;border-radius:8px;">
<a href="{{app_url}}/dashboard" target="_blank" style="display:inline-block;padding:12px 28px;font-size:14px;font-weight:600;color:#020617;text-decoration:none;border-radius:8px;">
View Announcement
</a>
</td>
</tr>
...
<td align="center" style="padding-top:24px;">
<p style="margin:0;font-size:12px;color:#64748b;line-height:1.5;">
You received this because you were included in a team announcement.
</p>
<p style="margin:6px 0 0;font-size:12px;color:#64748b;">
&copy; {{year}} {{app_name}}
</p>
